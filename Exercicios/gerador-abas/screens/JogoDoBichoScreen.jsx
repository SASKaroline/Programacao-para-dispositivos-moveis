...
export default function JogoDoBichoScreen() {
  ...
  return (
    <View style={styles.container}>
      <Button mode="contained" buttonColor="#7E57C2" textColor="#fff" onPress={gerarAnimal}>Gerar Animal</Button>
      {animalGerado && (
...
const styles = StyleSheet.create({
  ...
  card: { marginTop: 16, alignItems: 'center', backgroundColor: '#E1BEE7' },
  image: { width: 200, height: 200, marginTop: 8, borderRadius: 10 },
});