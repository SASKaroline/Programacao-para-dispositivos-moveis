...
export default function BookForm({ navigation, route }) {
  ...
  const onSubmit = async (formData) => {
    if (isEdit) {
      ...
      await saveBook({ ...formData, id: uuidv4() });
    }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Button mode="contained" onPress={handleSubmit(onSubmit)} style={styles.button} buttonColor={darkThemeColors.primary} textColor={darkThemeColors.surface}>
      ...
      <Snackbar
        ...
        duration={1500}
        style={{ backgroundColor: darkThemeColors.surface }}
        theme={{ colors: { inverseSurface: darkThemeColors.text, inverseOnSurface: darkThemeColors.surface } }}
      >
